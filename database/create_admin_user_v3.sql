-- Create Admin User for Tom Cassidy (Version 3 - Correct user_type)
-- This script creates the user in app_users and makes them a super admin
-- Run this entire file in Supabase SQL Editor

-- Step 1: Create user in app_users table (with correct user_type)
...
-- Expected results:
-- Step 3 should show your admin user details with user_type='registered'
