-- Fix User Sync Issue (Version 2 - Fixed)
-- This solves the problem where auth.users and app_users are out of sync
-- Run this entire file in Supabase SQL Editor

-- Step 1: Migrate all existing auth users to app_users (with user_type)
INSERT INTO app_users (id, email, display_name, user_type, subscription_tier, created_at, updated_at, metadata)
SELECT 
  id,
  email,
