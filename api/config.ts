...
export default function handler(req: VercelRequest, res: VercelResponse) {
  ...
  console.log('🔍 Environment Variables Debug:', {
    ...
    SUPABASE_SERVICE_KEY: process.env.SUPABASE_SERVICE_KEY ? `${process.env.SUPABASE_SERVICE_KEY.substring(0, 20)}...` : 'MISSING',
  ...
  const config = {
    ...
    configured: !!(process.env.SUPABASE_URL && process.env.SUPABASE_ANON_KEY && process.env.SUPABASE_SERVICE_KEY),
    debug: {
